...
# recode with tidy names
dframe <- 
  dframe %>%
  mutate(region = dplyr::recode(region, "Trøndelag - Trööndelage" = "Trøndelag", "Troms og Finnmark - Romsa ja Finnmárku" = "Troms og Finnmark"))
...
# The following snippet is done in collaboration with nesattorney(epe083/EirikEngmoPettersen)
room_capacity <- dframe[dframe$variable1 == "roomcap", ]
